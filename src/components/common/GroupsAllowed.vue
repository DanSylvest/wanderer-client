            ...
            <div v-if="loaded" class="wd-allowed-groups wd fs" :class="{opened: dialogActive}">
                ...
                >
                    ...
                    <template v-slot:row="{row}">
                        ...
                        <table-cell id="description">{{row.description}}</table-cell>
                    </template>
                </wd-table>
...
<script>
    ...
    export default {
        name: "Groups",
        components: {RelatedMaps, WdTable, TableCell, TableHeaderCell, AllowedGroupCharacters, CharacterWithTicker},
        props: [],
        data: function () {
            return {
                groupId: null,

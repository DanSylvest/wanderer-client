            ...
            <div class="wd-gl-2c">
              ...
              <div class="wd-route__destination">
                ...
                <tooltip
                  ...
                  class="wd initial-line-height initial-height wd-layout-secondary md-elevation-2"
                >
                  <system-card
                    :map-id="lMapId"
                    :solar-system-id="row.destination.toString()"
  ...
  export default {
    ...
    methods: {
      ...
      _onSubscribedAll () {
        ...
        this._unsubscribeMSSId = mapProvider.solarSystems.existence.on(
          'changedEvent',
          this._onSystemSubscriptionChange.bind(this),
        );
        this._unsubscribeMChainsId = mapProvider.chains.existence.on(
          'changedEvent',
          this._onChainsSubscriptionChange.bind(this),
        );
      },
      ...
      getShapeClass (data) {
        if (eveHelper.isPochvenSpace(data.systemClass) || (eveHelper.isKnownSpace(data.systemClass)
          && eveHelper.isTriglavianInvasion(data.triglavianInvasionStatus))) {

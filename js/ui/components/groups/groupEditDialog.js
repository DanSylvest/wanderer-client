(function () {
    var componentId = "ui/components/groups/groupEditDialog";

    var deps = [
        "env/promise",

        "ui/components/searchers/charactersSearcher",
        "ui/components/searchers/corporationsSearcher",
        "ui/components/searchers/alliancesSearcher",
    ];
            ...
            <md-tabs md-dynamic-height>
                ...
                <md-tab id="tab-characters" md-label="Characters">
                    <div style="padding: 20px; height: 500px " class="fs bs">
                        <c-characters-searcher ref="charactersSearcherRef" ></c-characters-searcher>
                    </div>
                </md-tab>
                
                <md-tab id="tab-corporations" md-label="Corporations">
                    <div style="padding: 20px; height: 500px " class="fs bs">
                        <c-corporations-searcher ref="corporationsSearcherRef" ></c-corporations-searcher>
                    </div>
                </md-tab>
                
                <md-tab id="tab-alliances" md-label="Alliances">
                    <div style="padding: 20px; height: 500px " class="fs bs">
                        <c-alliances-searcher ref="alliancesSearcherRef" ></c-alliances-searcher>
                    </div>
                </md-tab>
...
`;
        ...
        Vue.component("cGroupEditDialog", {
            props: [
